...
class NumberField extends JTextField implements KeyListener {
	...
	/**
	 * NumberField의 생성자
	 * @param i JTextField(int i) 의 i인 정수형 인자
	 */
	...
	/**
	 * TextField 안에 text를 변환하는 함수
	 * @param text 변환하고자 하는 정수형 인자
	 */
	...
	/**
	 * key가 타이핑 될 수 있는 것을 숫자로만 제한하는 함수
	 */
	...
	/**
	 * JTextField가 가지고 있는 값을 리턴하는 함수
	 * @return 값을 숫자로 변환시켜 리턴
	 */
